...
DOCS = {
    'MY_DOA_Pakej_Teknologi_Durian_2012.pdf': 'pdf_parse',
    'pt_durian_2012_MinerU__20251005065547.json': 'mineru_parse',
}
WINDOW = 24
MAX_ANCHORS = 8
MIN_LEN = 220
...
def main():
    ...
    json.dump(reachable, open('/tmp/ms_knownitem_set.json', 'w'), ensure_ascii=False)
    ...
    json.dump(res, open('/tmp/ms_knownitem_result.json', 'w'), ensure_ascii=False)
    n = len(res)
